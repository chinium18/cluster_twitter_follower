...
#        make_pairs(k, Sim_pair)
    ...
    with Pool(num_cores) as p:
        ...
        with open("./Sim_pair_mp/Sim_pair_"+str(os.getpid)+".pickle","wb") as pickle_out:
            pickle.dump(Sim_pair_list, pickle_out)
...
#for (k,v) in tqdm(dict_A.items()):
    ...
    with open("./Sim_pair_mp/Sim_pair.pickle","wb") as pickle_out:
